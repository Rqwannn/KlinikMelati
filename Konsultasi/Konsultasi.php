...
<head>
    ...
    <link rel="stylesheet" href="../CSS/konsultasi_responsive.css">
        ...
        <div class="col-md-12 d-flex justify-content-center">
            <div class="card-login">
                ...
                <div class="row">
                    ...
                    <div class="card-left position-relative overflow-hidden hidden-in-mobile">
                            ...
                            <div class="position-relative">
                                ...
                                <div class="content-login overflow-hidden">
                                    <div class="header-content">
                                        <h3 class="card-title text-center mt-3 mb-5">Konsultasi</h3>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-12 hidden-in-web">
                                            <div class="card-social-media d-flex justify-content-start flex-column">
                                                <h4 class="card-title mb-4">Spesialis</h4>
                                                <span class="text-white mb-4" id="ErrorSpesialis" style="display: none; font-size: 15px;"></span>
                                                <div class="spesialis mb-2 d-flex align-items-center badge bg-light position-relative">
                                                    <input type="radio" name="dokter" class="DokterUmum" value="Dokter Umum">
                                                    <div class="card-title text-dark" style="margin-left: 25px;">Dokter Umum</div>
